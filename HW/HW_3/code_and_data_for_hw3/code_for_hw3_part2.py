...
def eval_classifier(learner, data_train, labels_train, data_test, labels_test,p):
    th, th0 = learner(data_train, labels_train,params=p)
    return score(data_test, labels_test, th, th0)/data_test.shape[1]

def xval_learning_alg(learner, data, labels, k,params={}): #added p
    ...
    for i in range(k):
        ...
        score_sum += eval_classifier(learner, data_train, labels_train,
                                              data_test, labels_test,params) #added p
    return score_sum/k
...
data = load_auto_data(r'C:\Users\admin\Desktop\PreMaster\Maching_Learning\MIT_Open_Course\HW_3\code_and_data_for_hw3\auto-mpg.tsv')
#features,labels = auto_data_and_labels(data,[('cylinders',raw), ('displacement',raw), ('horsepower', raw),('weight',raw), ('acceleration',raw), ('origin',raw)])
feature_set_1 = [('cylinders',raw), ('displacement',raw), ('horsepower', raw),('weight',raw), ('acceleration',raw), ('origin',raw)]
...
#accuracy = xval_learning_alg(perceptron, feature, labels, k=10, params={'T': 10})
accuracy = xval_learning_alg(averaged_perceptron, feature, labels, k=10, params={'T': 10})
print(accuracy)
#num = (one_hot_2(feature[:1,:].T,labels,np.max(feature[:1,:]))).T
#hey = 9
# =============================================================================
# list_T = [1,10,50]
# for t in list_T:
#     print("Perceptron: ")
#     accuracy = xval_learning_alg(perceptron, features, labels, 10,p = {'T':  t})
#     print(accuracy)
#     print("AVG_Perceptron: ")
#     accuracy = xval_learning_alg(averaged_perceptron, features, labels, 10,p = {'T':  t})
#     print(accuracy)
# =============================================================================
# =============================================================================
# features,labels= auto_data_and_labels(data, [('cylinders', one_hot), ('displacement',standard), ('horsepower',standard), ('weight',standard), ('acceleration',standard), ('origin',one_hot)])
